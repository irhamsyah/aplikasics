...
{{ Form::model($value, array('url' => array('updatekirim', $value->id), 'method' => 'POST','class'=>'form-control')) }}

	<div class="form-group">
		{{ Form::label('1', 'Tanggal Kirim Dokumen') }}
		{{ Form::text('tanggal_kirim',null ,array('class' => 'form-control','autofocus'=>'','required'=>'','id'=>'inputdtpckr1')) }}
	</div>

	<div class="form-group">
		{{ Form::label('2', 'Tujuan Dokumen') }}
		{{ Form::text('tujuan', null, array('class' => 'form-control')) }}
	</div>

        <div class="form-group">
		{{ Form::label('3', 'UP') }}
                {{ Form::text('up',null, array('class' => 'form-control')) }}
	</div>

	<div class="form-group">
		{{ Form::label('4', 'Perihal Dokumen') }}
		{{ Form::textarea('perihal', null, array('class' => 'form-control')) }}
	</div>

	<div class="form-group">
		{{ Form::label('5', 'Pengirim') }}
		{{ Form::text('pengirim', null, array('class' => 'form-control')) }}
	</div>
